...
The Wavefront by VMware SDK for Python is the core library for sending metrics, histograms and trace data from your Python application to Wavefront using via proxy or direct ingestion.
...
```python
# Close the sender connection before shutting down the application
# This will flush in-flight buffers and close connections.
